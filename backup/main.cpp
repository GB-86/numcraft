  ...
  while (1) {
    ...
    if (!discretMode){
      ...
      if (keyboardState.keyDown(EADK::Keyboard::Key::Right)) {
        ...
        if (player.rotation.y<0){ player.rotation.y+=6.28318530718;}
        renderFrame(&player);
      }
      if (keyboardState.keyDown(EADK::Keyboard::Key::Left)) {
        player.rotation.y+=0.2;
        if (player.rotation.y>6.28318530718){ player.rotation.y-=6.28318530718;}
        renderFrame(&player);
      }
      if (keyboardState.keyDown(EADK::Keyboard::Key::Up)) {
        player.rotation.x-=0.2;
        if (player.rotation.y<-1.57079632679){ player.rotation.y=-1.57079632679;}
        renderFrame(&player);
      }
